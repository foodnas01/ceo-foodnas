...
<header class="header menu_fixed">
        ...
        <div id="logo">
            <a href="index.html">
                <img src="{{asset('frontend/img/logo.svg')}}" width="150" height="36" alt="" class="logo_normal">
                <img src="{{asset('frontend/img/logo_sticky.svg')}}" width="150" height="36" alt="" class="logo_sticky">
            </a>
        </div>
        <ul id="top_menu">
